...
class AccountPageLogic {
  ...
  Future getUserName() async {
    _model.userName = await SharedUtil.instance.getString(Keys.dbName);
  }
  ...
  void onLogoutPressed() {
    SharedUtil.instance.saveString(Keys.account, "default").then((v) {
      SharedUtil.instance.remove(Keys.dbAddr);
      SharedUtil.instance.remove(Keys.dbName);
      SharedUtil.instance.remove(Keys.dbAccount);
      SharedUtil.instance.remove(Keys.dbPasswd);
